  ...
  return (
    <section className="py-24 px-4 md:px-8 relative">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="bg-white p-12 md:p-16 rounded-lg shadow-md" data-scroll="zoom-in">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-2/3">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Concrétisez votre rêve automobile</h2>
            ...
            <div className="flex flex-col sm:flex-row md:flex-col gap-4">
              <Button className="bg-black hover:bg-black/80 text-white flex items-center gap-2 h-14 text-lg px-8">
                <Phone className="w-5 h-5" />
                <span>Nous appeler</span>
              </Button>
              <Button variant="outline" className="border-black text-black hover:bg-black hover:text-white flex items-center gap-2 h-14 text-lg px-8">
