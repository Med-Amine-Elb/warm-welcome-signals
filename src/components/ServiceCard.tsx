...
const ServiceCard = ({ icon, title, description, index = 0 }: ServiceCardProps) => {
  return (
    <Card 
      className="glass-card overflow-hidden hover-scale border-border/50 h-full"
      data-scroll="zoom-in"
    ...
    >
      ...
      <CardHeader className="relative z-10 flex items-center space-x-4 pb-2">
        <div className="flex-shrink-0 w-14 h-14 rounded-full bg-black/10 flex items-center justify-center text-black">
          {icon}
        </div>
